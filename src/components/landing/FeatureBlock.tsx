    ...
    <section className="bg-white py-[60px]">
      <div className="container-1200">
        <div ref={ref} className={`fade-up grid lg:grid-cols-2 gap-0 items-stretch ${reversed ? "lg:[&>*:first-child]:order-2" : ""}`}>
          <div className={`${bgClass} rounded-[8px] p-6 lg:p-8`}>
            <div className="bg-white rounded-[6px] shadow-[0_2px_12px_0_rgba(0,0,0,0.05)] border border-grey-stroke overflow-hidden h-full">
              {image}
            </div>
          </div>
