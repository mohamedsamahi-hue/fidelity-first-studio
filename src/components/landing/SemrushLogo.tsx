  ...
  return (
    <div className={`flex flex-col leading-none ${className}`}>
      <div className="flex items-center gap-2">
        ...
        <span className="text-[18px] font-bold tracking-tight text-brand-black">TRAFLIQ</span>
      </div>
      <span className="text-[10px] text-brand-black/70 mt-1 ml-[30px]">A Northwind Studio</span>
    </div>
  );
}
